            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div id="form-image" class="form-group row">
                        <div class="col-sm-2 col-form-label">
                            <strong class="field-title">ID card Signature Image</strong>
                        </div>
                        <div class="col-sm-10 col-content">
                            ...
                            <span
                                class="image-upload-label"><i class="fa fa-question-circle" aria-hidden="true"></i> Please upload the image (max 5MB)</span>
                            <div class="image-preview-area">
                             <div id="image_preview" class="image-preview">
                                    @if ($data->id_card_signature!=null)
                                        <img src="{{ asset('uploads/'.$data->id_card_signature) }}" width="160" title="image"
                                ...
                                {{-- <p class="delete-image-preview @if ($data->id_card_signature != null && $data->id_card_signature != 'default-user.png') show @endif"
