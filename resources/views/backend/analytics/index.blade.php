    ...
    <div class="card-body">
        ...
        <div id="date_filter" class="form-inline">
            <Form action="" method="get" class="form-inline col-sm-12" autocomplete="off">
                ...
                {{-- <div class="form-group mx-sm-3 mb-2">
                    <label for="tsm" class="mr-2">TSM</label>
                    <div class="input-group">
                        <select name="tsm" id="tsm" class="form-control">
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <label for="rsm" class="mr-2">RSM</label>
                    <div class="input-group">
                        <select name="rsm" id="rsm" class="form-control">
                            <option value="">All</option>
