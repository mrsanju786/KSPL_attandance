...
@section('title', 'Holiday  | ' . Config::get('adminlte.title'))
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <form class="form-inline" action="{{ url('holiday')}}" method="GET" style="float: right;">
            <div id="date_filter" class="form-inline">
                
                <div class="form-group mx-sm-3 mb-2">
                    <label for="to"></label>
                    <div class="input-group">
                        <select class="form-control"  name="regions" placeholder="Select Region">
