...
return [
    ...
    */
    ...
    'classes_body' => 'accent-purple', // ex: accent-purple
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Add Leave',
                    'url'  => 'leavebalance/add',
                    'icon' => 'fa fa-edit',
                ],
                [
                    'text' => 'Import CSV',
                    'url'  => 'leavebalance/import',
                    'icon' => 'fa fa-upload',
                ],
            ],
            'role' => 'administrator',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Horizontal Monthly',
                    'url'  => 'horizontal-attendances',
                    'icon' => 'fa fa-list-ul',
                ],
            ],
            'role' => 'administrator|admin',
        ...
        [
            ...
            'role' => 'administrator|admin|Level1(TSM)|Level1(RSM)',
        ],
        [
            'text' => 'Users',
            'icon' => 'fa fa-user',
